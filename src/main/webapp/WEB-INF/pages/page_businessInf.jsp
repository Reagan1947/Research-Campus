                ...
                <div class="row">
                    ...
                    <div class="col-md-6 ml-md-auto" id="rightCard">
                        ...
                        <div class="card card-outline card-primary" >
                            <div class="card-header">
                                <h3 class="card-title">流程图示 </h3>

                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" onclick="CpCard()" style="margin-top: auto;" id="cPButton">
...
<script>
    ...
    $.ajax({
        type: 'get',
        url: "https://research-campus-1256316910.cos.ap-chongqing.myqcloud.com/bpmn/50921d83c0e44d44b2d58dd3c41bc449.bpmn",//Servlet请求路径
        dataType: "text",
        async : false,
    ...
    viewer.importXML(diagramXML).then(function(){
        ...
        console.log(userTask.$attrs['activiti:formKey']) // 开始
