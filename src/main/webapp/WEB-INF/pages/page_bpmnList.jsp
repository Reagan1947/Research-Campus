            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="bpmnForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" accept=".bpmn" class="custom-file-input" id="uploadBpmn"
                                               name="uploadBpmn">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" accept=".svg" class="custom-file-input" id="uploadSvg"
                                               name="uploadSvg">
                            ...
                            <div class="form-group">
                                <label>流程描述</label>
                                <textarea class="form-control" rows="3" placeholder="process description"
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" id="uploadBpmnFile" data-dismiss="modal">上传流程
                        </button>
                    </div>
                </div>
                <!-- /.modal-content -->
                                        ...
                                        <div class="btn-group">
                                            <a href="${pageContext.request.contextPath}/buildBPMN">
                                                <button type="button" class="btn btn-default"><i
                                                        class="fas fa-plus"></i> 创建新流程
                                                </button>
                                            </a>
                                            <button type="button" class="btn btn-default" data-toggle="modal"
                                                    data-target="#modal-lg"><i class="fas fa-file-import"></i> 导入流程
                                            </button>
                                        </div>
                                    </td>
                                </div>
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        var html = "<div class='btn-group'>" +
                            ...
                            "<button type='button' onclick='deleteBpmn(" + uuid + ")' " + status_tag + "  class='btn btn-sm btn-default'><i class='far fa-trash-alt'></i> 删除</button>" +
                            "<button type='button' onclick='reviewBpmn(" + uuid + ")' class='btn btn-sm btn-default'><i class='fas fa-edit'></i> 编辑</button>" +
                            "<button type='button' onclick='depBpmn(" + uuid + ")' class='btn btn-sm btn-default'><i class='fas fa-check'></i> 部署</button>" +
                            "</div>"
                ...
                if ($table.hasClass('cards')) {
                    ...
                    $(".cards").find("tr").hover(function () {
                        ...
                        var txt2 = "<div class='btn-group test'>" +
                            ...
                            "<button type='button' onclick='deleteBpmn(" + uuid_string + ")' " + status_tag + " class='btn btn-default'><i class='far fa-trash-alt'></i></button>" +
                            "<button type='button' onclick='reviewBpmn(" + uuid_string + ")' class='btn btn-default'><i class='fas fa-edit'></i></button>" +
                            "<button type='button' onclick='depBpmn(" + uuid_string + ")' class='btn btn-default'><i class='fas fa-check'></i></button>" +
                            "</div>";
