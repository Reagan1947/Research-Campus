                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">科研处用户组管理</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">添加科研处用户组</h4>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" id="addResearchDepartmentGroup"
                                data-dismiss="modal">
                            添加科研处用户组
                        </button>
                    </div>
        ...
        <div class="modal fade" id="modal-researchSecretaryGroupInf" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content" id="app">
                    <div class="modal-header">
                        <h4 class="modal-title">更改科研处用户群组信息</h4>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" id="alterBpmnInf"
                                onclick="changeGroupOfResearchDepartment()" data-dismiss="modal">更改科研处用户组
                        </button>
                    </div>
                </div>
                <!-- /.modal-content -->
            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title" style="margin-top: 5px;">科研处用户组列表</h3>
                        <!-- 右侧按钮 -->
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default"
                                            onclick="addNewResearchDepartmentGroup()">
...
<script>
    ...
    function addNewResearchDepartmentGroup() {
        ...
        $("#jsGrid1").jsGrid({
            ...
            controller: {
                loadData: function (filter) {
                    ...
                    return $.ajax({
                        type: "GET",
                        url: "${pageContext.request.contextPath}/getGroupOfResearchDepartment",
                        data: filter,
                        dataType: "JSON"
                    })
    ...
    $("#addResearchDepartmentGroup").click(function () {
        toastr.info('正在添加科研秘书用户组信息！')
        var formData = new FormData($("#groupOfUserForm")[0]);
        formData.append("type", "researchDepartment");
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.code === 400) {
                    console.log(data);
                    toastr.error("添加科研秘处用户组信息失败！")
                } else if (data.code === 200) {
                    console.log(data);
                    // $('#image-uploading').fadeOut("slow");
                    toastr.success("添加科研秘处用户组信息成功！")
