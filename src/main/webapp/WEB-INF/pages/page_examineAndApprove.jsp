                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">科研项目审批</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">科研项目待审批认领列表</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
...
<script>
    $(document).ready(function () {
        $('#table_id').DataTable({
            ...
            ajax: "${pageContext.request.contextPath}/getExamineAndApproveTask",
            columns: [
                {"data": "taskId"},
                ...
                // 领取、审批、撤回
                {
                    ...
                    "data": function (row, type, val, meta) {
                        ...
                        return '<div class="btn-group"> ' +
                            ...
                            '<button type="button" class="btn btn-default" ' + examine + '><i class="fas fa-file-signature"></i></button> ' +
                            '<button type="button" class="btn btn-default" ' + cancel + '><i class="fas fa-reply"></i></button> ' +
                            '</div>'
                    }
                },
            ]
